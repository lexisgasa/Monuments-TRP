...
describe("Given the function generalError", () => {
  describe("When it receives a request", () => {
    ...
    const error = new ServerError("Resource not found", 404);
    ...
    test("Then it should return response's json method with the value 'Resource not found'", () => {
      const expectedErrorMessage = { message: "Resource not found" };
